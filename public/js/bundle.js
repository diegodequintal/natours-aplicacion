        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              // Si el api y el front estan en el mismo servidor, esto funciona. Sino no funciona, tendria que ponerle la url bien del api
              data: {
                email: email,
                // igual a email: email
                password: password
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWljaGlhbGxlYiIsImEiOiJjazhla3cyazQwMTBmM25vNzI0b2N4OTI3In0.xd5Nao5qCCC5gXV51fjajg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/michialleb/ck8ely02r3efs1imyx4luxj9x',
    scrollZoom: false //   center: [-118.188627, 34.069996],
    //   zoom: 9,
...
var stripe = Stripe('pk_test_mwnprq4r5KxVkjPSCi9SWpFp00QDs5SgJP');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3909" + '/');
